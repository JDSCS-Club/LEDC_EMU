...
uint8_t BSP_SRAM_Init(void)
{ 
  sramHandle.Instance = ((FSMC_Bank1_TypeDef *) (0xA0000000U + 0x0000U));
  sramHandle.Extended = ((FSMC_Bank1E_TypeDef *) (0xA0000000U + 0x0104U));
  ...
  Timing.AccessMode            = 0x00000000U;
  
  sramHandle.Init.NSBank             = 0x00000002U;
  sramHandle.Init.DataAddressMux     = 0x00000000U;
  sramHandle.Init.MemoryType         = 0x00000000U;
  sramHandle.Init.MemoryDataWidth    = 0x00000010U;
  sramHandle.Init.BurstAccessMode    = 0x00000000U;
  sramHandle.Init.WaitSignalPolarity = 0x00000000U;
  sramHandle.Init.WrapMode           = 0x00000000U;
  sramHandle.Init.WaitSignalActive   = 0x00000000U;
  sramHandle.Init.WriteOperation     = 0x00001000U;
  sramHandle.Init.WaitSignal         = 0x00000000U;
  sramHandle.Init.ExtendedMode       = 0x00000000U;
  sramHandle.Init.AsynchronousWait   = 0x00000000U;
  sramHandle.Init.WriteBurst         = 0x00000000U;
...
__weak void BSP_SRAM_MspInit(void)
{
  ...
  GPIO_Init_Structure.Pin   = ((uint16_t)0x0001) | ((uint16_t)0x0002) | ((uint16_t)0x0004)| ((uint16_t)0x0008) | ((uint16_t)0x0010)     |                              ((uint16_t)0x0020) | ((uint16_t)0x0200);
  
  HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)), &GPIO_Init_Structure);  
  

   
  dmaHandle.Init.Channel             = 0x00000000U;
  dmaHandle.Init.Direction           = ((uint32_t)(0x2U << (6U)));
  dmaHandle.Init.PeriphInc           = ((uint32_t)(0x1U << (9U)));
  dmaHandle.Init.MemInc              = ((uint32_t)(0x1U << (10U)));
  dmaHandle.Init.PeriphDataAlignment = ((uint32_t)(0x1U << (11U)));
  dmaHandle.Init.MemDataAlignment    = ((uint32_t)(0x1U << (13U)));
  dmaHandle.Init.Mode                = 0x00000000U;
  dmaHandle.Init.Priority            = ((uint32_t)(0x2U << (16U)));
  dmaHandle.Init.FIFOMode            = 0x00000000U;         
  dmaHandle.Init.FIFOThreshold       = ((uint32_t)(0x3U << (0U)));
  dmaHandle.Init.MemBurst            = ((uint32_t)(0x2U << (23U)));
  dmaHandle.Init.PeriphBurst         = ((uint32_t)(0x2U << (21U))); 
  
  dmaHandle.Instance = ((DMA_Stream_TypeDef *) (((0x40000000U + 0x00020000U) + 0x6400U) + 0x010U));
  
    
  do{ (hsram)->hdma = &(dmaHandle); (dmaHandle). Parent = (hsram); } while(0);
