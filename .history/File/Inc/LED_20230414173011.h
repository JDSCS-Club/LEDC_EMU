...
#define LED_OE_R_Port              GPIOD

#define LED_OE_G                  GPIO_PIN_13
#define LED_OE_G_Port               GPIOD

#define LED_OE_B                  GPIO_PIN_14
#define LED_OE_B_Port               GPIOD
...
#define LED_ADD_0_Port              GPIOC


#define LED_ADD_1                   GPIO_PIN_13
#define LED_ADD_1_Port              GPIOC

#define LED_ADD_2                   GPIO_PIN_14
#define LED_ADD_2_Port              GPIOC

#define LED_ADD_3                   GPIO_PIN_15
#define LED_ADD_3_Port              GPIOC



#define LED_DATA_R_1                  GPIO_PIN_6
#define LED_DATA_R_1_Port             GPIOC

#define LED_DATA_G_1                  GPIO_PIN_7
#define LED_DATA_G_1_Port             GPIOC


#define LED_DATA_B_1                  GPIO_PIN_8
#define LED_DATA_B_1_Port             GPIOC



#define LED_DATA_R_2                  GPIO_PIN_9
#define LED_DATA_R_2_Port             GPIOC


#define LED_DATA_B_2                  GPIO_PIN_10
#define LED_DATA_B_2_Port             GPIOC




#define LED_DATA_G_2                  GPIO_PIN_11
#define LED_DATA_G_2_Port             GPIOC
